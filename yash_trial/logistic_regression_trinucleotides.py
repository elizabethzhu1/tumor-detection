...
def main():
    ...
    results_dir = Path(__file__).resolve().parent / "results" / "trinucleotides"
    ...
    plot_coefficients_heatmap(clf.coef_, CATEGORIES, class_names, results_dir / "coefficients.png", annotate=False)
