...
def plot_feature_importances(importances, feature_names, save_path, top_n=20):
    ...
    ax.set_title(f'Gradient Boosting Top {top_n} Feature Importances', fontsize=12, fontweight='bold')
...
def main():
    ...
    plot_feature_importances(clf.feature_importances_, CATEGORIES, results_dir / "gb_feature_importances.png", top_n=20)
